          ...
          <div className="benefits-content-top">
            ...
            <div className="content-text">
              ...
              <p className="content-inner-text">
                오설록몰, 백화점 티샵, 티하우스를 통해 이모레퍼시픽 통합
                회원으로 가입하신 고객님께
                <br />
                누적 구매금액 기준으로 멤버십 등급이 부여되며, 등급에 따라
                혜택이 제공됩니다.
              </p>
            </div>
          </div>
          <div className="benefits-content-middile">
            <div className="content-middle-box">
              ...
              <ul className="content-list">
                ...
                <li>
                  입점 상품(티웨어, 바이탈 뷰티 등)에는 적용이 불가합니다.
                </li>
                <li>
                ...
                <li>
                  '다다일상 1회 체험권'은 22년 3-4월 중 특별 이벤트와 함께
                  발급될 예정입니다.
                </li>
              </ul>
            </div>
            <div className="content-bottom-box">
              ...
              <ul className="content-list">
                ...
                <li>
                  상반기 쿠폰북 - 1월 중순, 4월 초 / 하반기 쿠폰북 - 7월 초,
                  10월 초 발송됩니다.
                </li>
                <li>
                  1+1 지정 음료 쿠폰의 경우 멤버십 산정 직전 6개월간 티하우스
                  메뉴 5회 이상 구매 고객 대상으로 발송됩니다.
                </li>
              </ul>
